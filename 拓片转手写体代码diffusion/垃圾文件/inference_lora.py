...
# from u2net_infer.py import u2net_infer, load_u2net, download_u2net_model
...
def main(input_dir='input', output_dir='output', prompt='handwriting in oracle bone script style', controlnet_model = "lllyasviel/sd-controlnet-canny", base_model='runwayml/stable-diffusion-v1-5', strength=0.1, guidance_scale=7.5, threshold=128, structure_dir='structure'):
